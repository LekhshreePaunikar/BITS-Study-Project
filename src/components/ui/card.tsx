...
const CardTitle = React.forwardRef<HTMLHeadingElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
  return (
    <h4
      ref={ref}
...
const CardDescription = React.forwardRef<HTMLParagraphElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
  return (
    <p
      ref={ref}
